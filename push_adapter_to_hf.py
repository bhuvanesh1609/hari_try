...
def main() -> None:
    parser = argparse.ArgumentParser(description="Push LoRA adapter folder to Hugging Face Hub")
    ...
    if not local_path.exists() or not local_path.is_dir():
        raise FileNotFoundError(f"Adapter folder not found: {local_path}")
    ...
    print(f"Uploaded adapter folder {local_path} to https://huggingface.co/{args.repo_id}")
